...
const PuzzleEasy = () => {
  ...
  const initializeGame = () => {
    // Initialize board
    const initialBoard = Array(ROWS * COLUMNS).fill('../src/assets/images/puzzleEasy/blank.jpg');
    setBoardTiles(initialBoard);

    // Initialize pieces
    let initialPieces = Array.from({ length: ROWS * COLUMNS }, (_, i) => `../src/assets/images/puzzleEasy/${i + 1}.png`);
